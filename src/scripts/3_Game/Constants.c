...
//	bool m_isWinterMap;
	...
	override void Init()
	{
		...
		ConfigGetFloatArray("CfgSyberia MedicineSystem radiationLevels", m_radiationLevels, 4);	
		ConfigGetFloatArray("CfgSyberia MedicineSystem radiationHealthDamage", m_radiationHealthDamage, 4);
